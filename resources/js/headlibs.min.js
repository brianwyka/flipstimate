...
//# sourceMappingURL=../thirdparty/angular/angular.min.js.map
...
app.directive("category", function () {
   return {
       restrict: "E",
       templateUrl: "/pages/templates/category.html"
   };
});
...
app.controller("loginController", function ($scope, $filter, $interval, SpaceFactory, SpaceService, CategoryFactory, CategoryService) {
...
app.controller("signupController", function ($scope, $filter, $interval, SpaceFactory, SpaceService, CategoryFactory, CategoryService) {
